<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Assessment_Building_Valuation.ascx.cs" Inherits="Mitig8.Modules.Assessments.Assessment_Building_Valuation" %>
<%@ Register Assembly="System.Web.DataVisualization, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35" Namespace="System.Web.UI.DataVisualization.Charting" TagPrefix="asp" %>


<!-- Content Wrapper. Contains page content -->
<div id="modAssessmentBuildingValuation" class="content-wrapper">
                    ...
                    <div class="card card-warning card-tabs">
                        <div class="card-header p-0 pt-1">
                            <ul class="nav nav-tabs" id="MoveableAssetsControlTabControl" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="btnTabAssessmentClient" data-toggle="pill" href="#tabAssessmentClient" role="tab" aria-controls="custom-tabs-one-settings" aria-selected="true"><i class="far fa-building "></i>&nbsp;Valuation Details</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <div class="tab-pane fade" id="tabAssessmentProperty" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                        ...
                                        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0px !important">
                                            <div class="collapse navbar-collapse">
                                                <ul class="navbar-nav">
                                                    ...
                                                    <li class="nav-item">
                                                        <a onclick="AssessmentBuildingValuationControls.Functions.UploadAttachments();" style="color: #007bff !important; padding-left: 0.4rem !important; padding-right: 0.6rem !important" class="nav-link" href="#"><i class="fas fa-file-upload"></i>&nbsp;Upload Attachments</a>
                                                    </li>
                                    ...
                                    <div class="tab-pane fade" id="tabAssessmentTracks" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0px !important">
                                            <ul class="navbar-nav">
                                                ...
                                                <li class="nav-item">
                                                    <a onclick="AssessmentBuildingValuationControls.Functions.RefreshAssessmentTracks();" style="color: #007bff !important; padding-left: 0.4rem !important; padding-right: 0.6rem !important" class="nav-link" href="#"><i class="fas fa-sync"></i>&nbsp;Refresh</a>
                                                </li>
                                            </ul>
                                        </nav>
                                    ...
                                    <div class="tab-pane fade" id="tabAssessmentUsers" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0px !important">
                                            <ul class="navbar-nav">
                                                <li class="nav-item">
                                                    <a onclick="AssessmentBuildingValuationControls.Functions.AssignUser();" style="color: #007bff !important; padding-left: 0.4rem !important; padding-right: 0.6rem !important" class="nav-link" href="#"><i class="fas fa-user-plus"></i>&nbsp;Assign User</a>
                                                </li>

                                                <li class="nav-item">
                                                    <a onclick="AssessmentBuildingValuationControls.Functions.RefreshAssessmentUsers();" style="color: #007bff !important; padding-left: 0.4rem !important; padding-right: 0.6rem !important" class="nav-link" href="#"><i class="fas fa-sync"></i>&nbsp;Refresh</a>
                                                </li>
                                            </ul>
                                        </nav>
                                    ...
                                    <div class="tab-pane fade " id="tabAssessmentQuotes" role="tabpanel" aria-labelledby="custom-tabs-one-settings-tab">
                                        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0px !important">
                                            <div class="collapse navbar-collapse">
                                                <ul class="navbar-nav">
                                                    <li class="nav-item">
                                                        <a id="btnAddQuote" onclick="AssessmentBuildingValuationControls.Functions.AddQuote();" style="color: #007bff !important; padding-left: 0.4rem !important; padding-right: 0.6rem !important" class="nav-link" href="#"><i class="fas fa-plus"></i>&nbsp;Add Quote</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a onclick="AssessmentBuildingValuationControls.Functions.RefreshAssessmentQuotes();" style="color: #007bff !important; padding-left: 0.4rem !important; padding-right: 0.6rem !important" class="nav-link" href="#"><i class="fas fa-sync"></i>&nbsp;Refresh</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </nav>
                                ...
                                <div class="tab-pane fade" id="tabAssessmentBuildings" role="tabpanel" aria-labelledby="custom-tabs-one-settings-tab">
                                    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0px !important">
                                        <div class="collapse navbar-collapse" id="navbarNavBuilding">
                                            <ul class="navbar-nav">
                                                <li class="nav-item">
                                                    <a onclick="AssessmentBuildingValuationControls.Building.Open(0);" style="color: #007bff !important; padding-left: 0.4rem !important; padding-right: 0.6rem !important" class="nav-link" href="#"><i class="fas fa-home"></i>&nbsp;Add Building</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </nav>
                                        ...
                                        <nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0px !important">
                                            <ul class="navbar-nav">
                                                <li class="nav-item">
                                                  ...
                                                  <li class="nav-item">
                                                    <a style="color: #007bff !important; padding-left: 0.4rem !important; padding-right: 0.6rem !important;cursor:pointer !important" class="nav-link" onclick="AssessmentBuildingValuationControls.Functions.DownloadReport();"><i class="far fa-file-pdf"></i>&nbsp;Download</a>
                                                </li>
                                            </ul>
                                        </nav>
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel14" UpdateMode="Conditional" ChildrenAsTriggers="true">
                <ContentTemplate>
                    ...
                    <div class="modal-footer">
                        <asp:Button Style="float: left !important" data-dismiss="modal" runat="server" OnClientClick="$('#Assessment_Building_Valuation_btnAssessmentAttachments').click();('#Assessment_Building_Valuation_btnAssessmentAttachments').click();" CssClass="btn btn-warning pull-right" Text="Done" />
                    </div>
                </ContentTemplate>
...
<script type="text/javascript">
    ...
    let AssessmentBuildingValuationControls = {
        Initialze: (Data) => {
            $('#<%=vAssessmentID.ClientID.ToString()%>').val(Data);
            $('#<%=btnInitialize.ClientID.ToString()%>').click();
            changeUrl('MODULE', 'ASSESSMENT_BUILDING_VALUATION');
            changeUrl('DATA', Router.Functions.Encode(Data));
            $('.content-wrapper').hide();
            $('#modAssessmentBuildingValuation').fadeIn(5000);
        },
        Declare: () => {
