...
namespace Mitig8
{
    public partial class InvoiceInsurer : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            litInvoice.Text = dataModal.PDF_getInvoice_Insurer(int.Parse(Assessment)).ToList()[0].ToString();
    ...
    Request.ApplicationPath.TrimEnd('/') + "/documents/invoice-insurer?download=no&Assessment=" + Assessment;
