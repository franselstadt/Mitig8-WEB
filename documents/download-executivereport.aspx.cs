...
{
    public partial class download_executivereport : System.Web.UI.Page
    {
    ...
    Request.ApplicationPath.TrimEnd('/') + "/documents/download-executivereport?dl=0&aid=" + Request.QueryString["AID"].ToString() + "&set=" + Pages[x].Number.ToString();
    ...
    pdf_page_size, true);
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ExecutiveSummary-Assessment-"+ Request.QueryString["AID"].ToString() + ".pdf");
